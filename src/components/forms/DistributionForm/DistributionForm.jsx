...
import { Grid, Typography, Button, MenuItem, Chip } from '@material-ui/core'
  ...
  return (
    <React.Fragment>
        ...
        <FieldArray name='formats'>
          {(arrayHelpers) => (
            <Grid container item spacing={3} xs={12}>
              <Grid item xs={9}>
                <CustomTextField fullWidth placeholder='Format' name='format' />
              </Grid>
              <Grid item xs={3}>
                <Button
                  onClick={() => {
      ...
      <Grid item xs={12}>
        ...
        <Grid container item spacing={3} xs={12}>
          <Grid item xs={9}>
            <CustomTextField fullWidth placeholder='Size' name='size.value' />
          </Grid>
          <Grid item xs={3}>
